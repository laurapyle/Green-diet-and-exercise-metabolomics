...
auc_save <- diet.perf.splsda.loo$auc$comp1[1]
...
dietunk.perf.splsda.loo = perf(splsda.diet.unk, validation = 'loo', 
                        progressBar = FALSE, auc=TRUE)
auc_save_unk <- dietunk.perf.splsda.loo$auc$comp1[1]
...
Leave-one-out cross-validation was used to examine the performance of the sPLS-DA model based on diet vs. no-diet, using all metabolites. 

 Overall Error rate component 1: `r dietunk.perf.splsda.loo$error.rate$overall`
