...
dietmat_nounk<-nomissdf_nounk.log$featuredata[which(nomissdf_nounk.log$featuredata[,1]==1),-1]
nodietmat_nounk<-nomissdf_nounk.log$featuredata[which(nomissdf_nounk.log$featuredata[,1]==0),-1]

#Linear model fit with ordinary statistics
ordFit<-LinearModelFit(featuredata=data.matrix(dietmat_nounk-nodietmat_nounk),
                       ruv2=FALSE,
...
modFit<-LinearModelFit(featuredata=data.matrix(dietmat_nounk-nodietmat_nounk),
                       ruv2=FALSE,
                       moderated=TRUE,
                       factormat=matrix(1,nrow=nrow(dietmat_nounk)),
