...
HeatMap(featuredata = nomissdf_nounk.log.nm$featuredata,groupdata = nomissdf_nounk.log.nm$groupdata$Group,interactiveplot = FALSE,
        colramp=c(75,"magenta","green"),key=FALSE,dendrogram = "both",saveplot = TRUE,margins = c(10,22),cexRow = 0.2)
...
# THIS IS WHERE I STOPPED - NEED TO CONVERT TO PROPER DATA FORMAT FOR NORMALIZEMETS
